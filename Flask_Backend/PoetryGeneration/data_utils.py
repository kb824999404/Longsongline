...
from PoetryGeneration.char_dict import end_of_sentence, start_of_sentence
from PoetryGeneration.paths import gen_data_path, plan_data_path, check_uptodate
from PoetryGeneration.poems import Poems
from PoetryGeneration.rank_words import RankedWords
from PoetryGeneration.segment import Segmenter
import re
import subprocess
