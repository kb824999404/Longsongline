...
ap.add_argument("-f", "--voice_factor", required=False, default=0.5,    #混合系数
   help="Blend Factor of voice")
...
if __name__ == "__main__":
    ...
    synthesizer = SingingSynthesizer.SingingSynthesizer(fs)
    synthesizer.voiceSynthesis(VOICE_ROOT,lyrics,song)
	...
	[float(args.voice_factor),1-float(args.voice_factor)])
